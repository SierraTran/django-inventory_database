...
# XXX: These tests make antivirus software suspicious of the program,
# so they will be disabled for now.
# They can be re-enabled later if needed.

# To enable these tests, delete the "#" at the beginning of each line below this comment.
