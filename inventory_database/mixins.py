"""
    This module holds custon mixins for the project, specifically for allowing users in certain groups to access certain views.
    The mixins are used in the views.py file of both apps.
    
    ### Mixins:
        - UserPassesTestMixin: 
            This mixin is used for checking if a user passes a certain test. It is used as a base class for the other mixins.
...
class SuperuserOrTechnicianRequiredMixin(UserPassesTestMixin):
    ...
    def test_func(self) -> bool:
        ...
        This method checks the first group the current user belongs to. If the group exists and its name is 
        "Superuser" or "Technician", it returns True; otherwise, it returns False.
...
class TechnicianRequiredMixin(UserPassesTestMixin):
    ...
    def test_func(self) -> bool:
        ...
        This method checks the first group the current user belongs to. If the group exists and its name is 
        "Technician", it returns True; otherwise, it returns False.
...
class InternRequiredMixin(UserPassesTestMixin):
    ...
    def test_func(self) -> bool:
        ...
        This method checks the first group the current user belongs to. If the group exists and its name is 
        "Intern", it returns True; otherwise, it returns False.
